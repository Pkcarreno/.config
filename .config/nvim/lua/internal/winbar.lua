...
M.gps = function()
  ...
  if navic_location == "error" then
    ...
    if not isempty(navic_location) then
      return retval .. " "  .. "#" .. Config.icons.caretRight .. "%*" .. " " .. navic_location
    else
      return retval
    end
  end
...
vim.api.nvim_create_autocmd({ "CursorMoved", "BufWinEnter", "BufFilePost" }, {
  callback = function()
    ...
    if vim.bo.filetype == "dapui_watches" then
      vim.opt_local.winbar = " " .. "#" .. require("utils.icons").watch .. "Watches" .. "%*"
      return
    end

    if vim.bo.filetype == "dapui_stacks" then
      vim.opt_local.winbar = " " .. "#" .. require("utils.icons").git .. "Stacks" .. "%*"
      return
    end

    if vim.bo.filetype == "dapui_breakpoints" then
      vim.opt_local.winbar = " " .. "#" .. require("utils.icons").bigCircle .. "Breakpoints" .. "%*"
      return
    end

    if vim.bo.filetype == "dapui_scopes" then
      vim.opt_local.winbar = " " .. "#" .. require("utils.icons").telescope .. "Scopes" .. "%*"
      return
    end
    ...
    if vim.bo.filetype == "dapui_console" then
      vim.opt_local.winbar = " " .. "#" .. require("utils.icons").console .. "Console" .. "%*"
      return
    end
    ...
    if vim.bo.filetype == "GitBlame" then
      vim.opt_local.winbar = " " .. "#" .. require("utils.icons").git .. "Blame" .. "%*"
      return
    end
